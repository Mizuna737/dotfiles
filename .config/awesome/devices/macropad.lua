...
macropad.globalkeys = gears.table.join(
	...
	-- Button 4 short => Meta+Alt+4 => Load Work Config
	...
	-- Button 4 long => Meta+Alt+Control+4 => Save Obsidian Config
